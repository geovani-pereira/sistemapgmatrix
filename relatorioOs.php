        ...
        <div class="panel panel-edt">
            <div class="panel-heading panel-edt2">
                <h4 class="text-center panel-edt3">
                    <i class="fa fa fa-tags fa-1x" aria-hidden="true"></i> RELATÓRIO ORDEM DE SERVIÇO</h4>
            </div>
            ...
            <div class="panel-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#home" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa fa-tags fa-1x" aria-hidden="true"></i> Ordem</a>
                    </li>
                </ul> <br><br>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home">
                        <form name="form1" method="get" action="listaRelatorioOs.php" enctype="multipart/form-data" novalidate>
                            <fieldset>
                                <div class="col-md-2">
